...
FASTQ_DIR="${BASE_DIR}/data/1cleaned_reads_re"
TRIMMED_DIR="${BASE_DIR}/data/1cleaned_2trim_reads_re"
...
parallel -j 3 ::: \
    "multiqc qc_reports/before_trimming/ -o qc_reports/ -n 1cleaned_reads_re --title '1cleaned_reads_re' --force -q" \
    "multiqc qc_reports/after_trimming/ -o qc_reports/ -n 1cleaned_2trim_reads_re --title '1cleaned_2trim_reads_re' --force -q" \
    "multiqc ${LOG_DIR}/trimmomatic/ -o qc_reports/ -n 1c_to_2t_reads_re --title '1c_to_2t_reads_re' --force -q"
